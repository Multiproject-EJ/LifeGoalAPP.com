...
exports.getIslandRarity = getIslandRarity;
exports.generateTileMap = generateTileMap;
 ...
 * - rest = normal
 */
function getIslandRarity(islandNumber) {
...
function computeEncounterIndicesForProfile(rarity, tileCount) {
 ...
 */
function generateTileMap(islandNumber, rarity, _themeId, dayIndex, options) {
    const boardProfile = (0, islandBoardProfiles_1.resolveIslandBoardProfile)(options?.profileId);
