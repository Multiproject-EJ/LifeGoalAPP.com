...
exports.DICE_REGEN_FULL_WINDOW_MS = void 0;
exports.resolveDiceRegenMinDice = resolveDiceRegenMinDice;
exports.resolveDiceRegenRatePerHour = resolveDiceRegenRatePerHour;
exports.buildInitialDiceRegenState = buildInitialDiceRegenState;
exports.applyDiceRegeneration = applyDiceRegeneration;
exports.resolveNextRollEtaMs = resolveNextRollEtaMs;
exports.resolveFullRefillEtaMs = resolveFullRefillEtaMs;
// ── Continuous formula ──────────────────────────────────────────────────
...
exports.DICE_REGEN_FULL_WINDOW_MS = 2 * 60 * 60 * 1000;
 ...
 */
function applyDiceRegeneration(params) {
 ...
 */
function resolveNextRollEtaMs(params) {
    ...
    if (safeTarget > maxDice)
        return Number.POSITIVE_INFINITY;
    if (regenRatePerHour <= 0)
        return Number.POSITIVE_INFINITY;
 ...
 */
function resolveFullRefillEtaMs(params) {
