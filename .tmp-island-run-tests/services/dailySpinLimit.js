...
exports.STRICT_DAILY_SPIN_LIMIT = void 0;
exports.clampSpinsForStrictDailyLimit = clampSpinsForStrictDailyLimit;
/**
...
exports.STRICT_DAILY_SPIN_LIMIT = 1;
function clampSpinsForStrictDailyLimit(spins) {
    if (!(0, islandRunFeatureFlags_1.isIslandRunFeatureEnabled)('todaysOfferSpinEntryEnabled')) {
        return spins;
    }
    if (!Number.isFinite(spins))
        return 0;
    return Math.max(0, Math.min(exports.STRICT_DAILY_SPIN_LIMIT, Math.floor(spins)));
}
