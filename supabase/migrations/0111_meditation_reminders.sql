-- Migration: Meditation Reminders
-- Description: Create meditation_reminders table for breathing space reminder notifications
-- Required for: Breathing Space feature reminder functionality
