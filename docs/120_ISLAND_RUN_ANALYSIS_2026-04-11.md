...
- Fixed 17-tile gameplay profile (`legacy17`) is active.
...
- Production board remains effectively legacy 17-tile in current renderer/runtime, while canonical requires profile-driven variable board topology.
