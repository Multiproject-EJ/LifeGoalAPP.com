...
- [🟡] M16: Collectible Progress Bar — shard sub-currency, repeating milestone chain, pill HUD component (design locked in docs/13_COLLECTIBLE_PROGRESS_BAR.md; build slices M16A–M16I); M16A shipped; M16B shard earn logic shipped; M16C HUD pill shipped
...
**Objective:** [⛔] M16D: Collectible Progress Bar — Claim button + blind-box reward reveal: dynamic reward pool logic (deficit detection, boss proximity, streak, era bonus)
