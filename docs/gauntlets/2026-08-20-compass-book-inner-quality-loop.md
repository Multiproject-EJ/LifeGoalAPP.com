...
Compass Book assertions, strict sculpt validation, TypeScript, and diff hygiene pass. The img2threejs pipeline has advanced through blockout, structural-pass, form-refinement, material-pass, surface-pass, lighting-pass, and interaction-pass acceptance; **optimization-pass** is the final sculpt gate. Physical supported-iPhone performance remains an explicit launch gate.
