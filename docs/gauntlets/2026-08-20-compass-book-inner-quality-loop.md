...
Compass Book assertions, the launch contract, TypeScript, and diff hygiene pass. The img2threejs pipeline has advanced through blockout, structural-pass, form-refinement, and material-pass acceptance; **surface-pass** is the next gated pass.
