...
HERE=Path(__file__).resolve().parent;path=HERE/'event-v01.glb';raw=path.read_bytes();assert raw[:4]==b'glTF'
...
(HERE/'event-v01-export-checks.json').write_text(json.dumps(result,indent=2)+'\n')
