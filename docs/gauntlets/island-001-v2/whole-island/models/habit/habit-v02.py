...
root=empty('ISLAND_001_V2_HABIT_OAK');root['landmarkId']='habit';root['id']='habit';root['logicalAxes']='Y-up;front+Z;ground0';root['assetStatus']='whole-island-v02-draft';root['sockets']={'lift':[.72,.15,1.07]}
...
(OUT/'habit-v02-metadata.json').write_text(json.dumps(report,indent=2)+'\n')
bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'habit-v02.blend'))
bpy.ops.export_scene.gltf(filepath=str(OUT/'habit-v02.glb'),export_format='GLB',export_yup=True,export_extras=True,export_materials='EXPORT',export_cameras=False,export_lights=False)
