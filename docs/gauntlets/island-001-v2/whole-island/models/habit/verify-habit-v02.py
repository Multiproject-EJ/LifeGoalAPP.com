...
HERE=Path(__file__).resolve().parent;path=HERE/'habit-v02.glb';raw=path.read_bytes();assert raw[:4]==b'glTF'
...
(HERE/'habit-v02-export-checks.json').write_text(json.dumps(result,indent=2)+'\n')
