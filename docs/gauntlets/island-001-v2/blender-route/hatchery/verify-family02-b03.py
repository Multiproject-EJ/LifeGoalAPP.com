...
path=HERE/'family02-blockout-b03.glb'
...
roof=json.loads((HERE/'family02-blockout-b03-support-checks.json').read_text());assert roof['noBooleanModifiers'] and all(r['passed'] for r in roof['roofChecks'])
...
(HERE/'family02-blockout-b03-export-checks.json').write_text(json.dumps(result,indent=2)+'\n')
