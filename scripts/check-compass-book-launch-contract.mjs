...
requireText(model, 'createPersonalPlaybookRelief(', 'Chapter VI must retain its production Personal Playbook relief.');
requireText(model, "root.userData.compassPageId = 'personal_playbook'", 'Chapter VI must own a page-addressable Personal Playbook relief.');
requireText(model, "'personal-playbook-relief': personalPlaybook.root", 'The Personal Playbook must remain a named runtime part.');
requireText(model, "selectedPageId === 'personal_playbook'", 'The Personal Playbook must be visibility-gated by canonical active page.');
requireText(model, 'playbookChapterCelebration', 'Chapter VI must retain its bounded chapter-completion ceremony.');
requireText(model, 'playbookFragmentCelebration', 'Chapter VI must retain its single-fragment completion ceremony.');
requireText(model, "'module-environment-shield': environmentShield", 'Chapter VI must preserve seven separately named flight-system modules.');
...
requireText(styles, ":not([data-page-id='personal_playbook'])", 'Chapter VI must retain the approved wide hybrid spread.');
