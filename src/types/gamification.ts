...
export type LeaderboardScope = 'all_time' | 'weekly' | 'monthly';
export type LeaderboardCategory = 'level' | 'xp' | 'streak' | 'achievements' | 'points';
...
// Prize tiers for leaderboard rankings
export const LEADERBOARD_PRIZE_TIERS = {
...
export const DEMO_LEADERBOARD_KEY = 'lifegoal_demo_leaderboard_entries';
export const DEMO_LEADERBOARD_REWARDS_KEY = 'lifegoal_demo_leaderboard_rewards';
