...
export type TelemetryEventType =
  ...
  | 'contract_achievement_check'
  | 'contract_cascading_unlocked'
  | 'contract_redemption_quest_generated'
  | 'contract_redemption_quest_completed'
  | 'contract_redemption_quest_failed'
  | 'contract_zen_reward_awarded'
