    ...
    Tables: {
      ...
      island_run_runtime_state: {
        Row: {
          ...
          shields: number;
          shards: number;
          active_egg_tier: string | null;
          active_egg_set_at_ms: number | null;
          active_egg_hatch_duration_ms: number | null;
          active_egg_is_dormant: boolean;
          per_island_eggs: Json;
      ...
      commitment_contracts: {
        Row: {
          ...
          created_at: string;
          updated_at: string;
          contract_type: 'classic' | 'identity' | 'escalation' | 'redemption' | 'reputation' | 'reverse' | 'multi_stage' | 'future_self' | 'narrative' | 'sacred' | 'cascading';
          contract_tier: 'common' | 'rare' | 'epic' | 'legendary' | 'sacred';
