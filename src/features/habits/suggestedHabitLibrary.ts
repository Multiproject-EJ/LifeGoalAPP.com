export type SuggestedHabitLifeWheelArea =
  | 'Health'
  | 'Mind'
  | 'Work'
  | 'Money'
...
const STARTER_HABIT_BY_AREA: Record<SuggestedHabitLifeWheelArea, SuggestedHabit> = {
  Health: SUGGESTED_HABITS[0],
  Mind: SUGGESTED_HABITS[3],
  Work: SUGGESTED_HABITS[6],
  Money: SUGGESTED_HABITS[9],
  Relationships: SUGGESTED_HABITS[12],
  Home: SUGGESTED_HABITS[15],
  Growth: SUGGESTED_HABITS[18],
  Fun: SUGGESTED_HABITS[21],
};
