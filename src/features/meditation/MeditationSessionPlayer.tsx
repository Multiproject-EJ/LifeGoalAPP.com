...
type GongPartial = { frequency: number; gain: number; decay: number };
...
export function MeditationSessionPlayer({
  ...
  // Keep a single gong callback identifier (no aliasing) to avoid redeclare/build errors.
