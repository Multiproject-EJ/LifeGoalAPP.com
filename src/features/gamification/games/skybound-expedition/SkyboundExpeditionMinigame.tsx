...
const TERMINAL_COPY:Record<Exclude<SkyboundFlightState['terminalReason'],null>,{label:string;detail:string}>={
  ...
  hard_impact:{label:'HARD TERRAIN IMPACT',detail:'Too much descent energy reached the ground.'},
