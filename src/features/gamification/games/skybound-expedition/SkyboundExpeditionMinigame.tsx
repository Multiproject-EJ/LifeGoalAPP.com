...
export default function SkyboundExpeditionMinigame({onComplete,ticketBudget=0,launchConfig}:IslandRunMinigameProps) {
  ...
  },[canonicalConfig,lesson.goalDistance,lesson.id,lesson.levelId,level.id,rank.aircraftId,setAcademy,setAim,setPhase,setUpgrades]);
