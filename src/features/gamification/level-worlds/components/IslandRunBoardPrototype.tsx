...
const FOOTER_CONTROLLER_SLOT_MAP: Record<FooterControllerSlotId, FooterControllerSlot> = {
  ...
  // occupies the upper blue bowl, and the multiplier badge sits just above
  // the roll control so it stays close without covering the CTA.
  ...
  centerBadge: { x: 50, y: 5, rotate: 0, scale: 0.94, depth: 'surface' },
