...
export const authoredCaretakerConcordEntries: IslandCaretakerConcordContentEntry[] = [
  buildCaretakerConcordContentEntry({
    ...
    roleLabel: 'Keeper of Questions',
    civilizationName: 'The Tidefolk of The Last Word',
    biome: 'underwater',
    nextStep: {
      title: 'What should I do next?',
      lines: ['The Last Word has named you in a prophecy.', 'Restore the landmarks and watch who turns warnings into instructions.'],
      prompt: 'How do you answer?',
      branches: [
        { id: 'why-hatchery', label: 'Why the Hatchery?', response: 'New life gives the plaza a reason to gather. The board wants witnesses; we need proof.' },
        { id: 'begin-there', label: 'I’ll begin there.', response: 'Then begin carefully. A useful warning becomes dangerous when no one may question it.' },
      ],
    },
    aboutIsland: {
      title: 'Tell me about Pebble Bay.',
      lines: ['Pebble Bay trusts The Last Word: a sacred board that spells what seems inevitable.', 'Above us hangs the second sun, an ancient lantern the board says must not be powered down.'],
      prompt: 'What would you like to know?',
      branches: [
        { id: 'second-sun', label: 'The second sun?', response: 'A controlled sky-lantern. If its descent locks are open, it is no symbol.' },
        { id: 'who-maelis', label: 'Who is Maelis?', response: 'Our old tide guardian. Her rescued warnings made many believe the board could never lie.' },
      ],
    },
    aboutCaretaker: {
      title: 'Who are you?',
      lines: ['I am Sela, a Keeper of Questions.', 'My family tends The Last Word. I am learning that tending is not the same as obeying.'],
      prompt: 'What do you ask?',
      branches: [
        { id: 'tidefolk', label: 'Tell me about the Tidefolk.', response: 'We are patient shore-people. Patience saved us often; certainty is what trapped us.' },
        { id: 'concord-thanks', label: 'I’m glad I can hear you.', response: 'Then hear this too: if the board keeps moving when I let go, it was never only us.' },
      ],
    },
  }),
  buildCaretakerConcordContentEntry({
