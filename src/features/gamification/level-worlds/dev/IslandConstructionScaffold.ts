...
export const ISLAND_CONSTRUCTION_SCAFFOLD_PROFILES: Readonly<Record<number, IslandConstructionScaffoldProfile>> = {
  ...
  15: { id: 'crystal-glacier-aurora-frame', label: 'Sapphire crystal, moon-silver, and aurora braces', primary: 0x153f83, secondary: 0xbdefff, accent: 0xa864ff, motif: 'crystal', metallic: true },
