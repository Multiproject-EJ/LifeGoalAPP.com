...
const ISLAND_CHAMPIONSHIP_PRESENTATIONS: Record<number, IslandChampionshipPresentation> = {
  ...
  20: {
    islandNumber: 20,
    championshipId: 'golden-winds',
    tier: 'host-cup',
    theme: 'golden',
    eyebrow: 'Host Cup · Second Invitation',
    title: 'Golden Winds Cup',
    tagline: 'Follow the wind. Find your way into the final.',
    summary: 'Golden Sands turns its Arena into a joyful invitational of timing, courage and improvisation—the final rehearsal before formal circuit play.',
    hostIslandName: 'Golden Sands',
    ceremonyCallout: 'Raise the golden sails',
    artSrc: '/assets/story/championships/circuit-cups/golden-winds/opening-ceremony-portrait.webp',
    portraitArtSrc: '/assets/story/championships/circuit-cups/golden-winds/opening-ceremony-portrait.webp',
    artAlt: 'Golden wind ribbons forming a luminous bird over a desert sail Arena.',
    stages: HOST_CUP_STAGES,
  },
  30: {
    islandNumber: 30,
