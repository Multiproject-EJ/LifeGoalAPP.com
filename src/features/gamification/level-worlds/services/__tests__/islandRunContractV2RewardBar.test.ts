...
export const islandRunContractV2RewardBarTests: TestCase[] = [
  ...
  },
  {
    ...
    run: () => {
      ...
      assertEqual(x10!.unlocked, true, 'Expected ×10 unlocked at 10 dice');
  ...
  },
  {
    ...
    run: () => {
      ...
      assert(unlocked50.includes(20), 'Expected ×20 unlocked at 50 dice');
      assert(!unlocked50.includes(50), 'Expected ×50 locked until 250 dice');
      ...
      assert(unlocked1000.includes(200), 'Expected ×200 unlocked at 1000 dice');
    },
  },
  {
    ...
    run: () => {
      ...
      assertEqual(resolveMaxMultiplierForPool(10), 10, 'Expected max ×10 at 10 dice');
      ...
      assertEqual(resolveMaxMultiplierForPool(1000), 200, 'Expected max ×200 at 1000 dice');
    },
  },
  {
  ...
  },
  {
    ...
    run: () => {
      ...
      assertEqual(clampMultiplierToPool(20, 15), 10, 'Expected clamp to ×10 at 15 dice');
