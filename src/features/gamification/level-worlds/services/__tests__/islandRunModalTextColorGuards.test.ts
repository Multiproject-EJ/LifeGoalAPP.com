...
export const islandRunModalTextColorGuardTests: TestCase[] = [
  ...
  { name: 'dialogue and toast define explicit text and button colors', run: () => {
    ['.island-narrative-dialogue', '.island-narrative-dialogue__speaker-kicker', '.island-narrative-dialogue__speaker', '.island-narrative-dialogue__copy--secondary', '.island-narrative-dialogue__continue', '.island-narrative-toast', '.island-narrative-toast__card', '.island-narrative-toast__label', '.island-narrative-toast__speaker', '.island-narrative-toast__role', '.island-narrative-toast__text', '.island-narrative-toast__landmark'].forEach((selector) => assertSelectorHasColor(selector));
  } },
