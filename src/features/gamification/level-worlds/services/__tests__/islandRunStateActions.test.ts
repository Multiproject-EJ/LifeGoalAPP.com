...
export const islandRunStateActionsTests: TestCase[] = [
      ...
      const cases = [
        {
          ...
          expectedStatuses: ['active', 'accessible', 'accessible', 'accessible', 'locked'],
        ...
        },
        {
          ...
          expectedStatuses: ['completed', 'active', 'accessible', 'accessible', 'locked'],
        ...
        },
        {
          ...
          expectedStatuses: ['completed', 'completed', 'active', 'accessible', 'locked'],
        ...
        },
        {
          ...
          expectedStatuses: ['completed', 'completed', 'completed', 'active', 'locked'],
  ...
  },
  {
    ...
    run: () => {
      ...
      assertDeepEqual(resolved.statusesByIndex, ['completed', 'postponed', 'active', 'accessible', 'locked'], 'Mystery is freely accessible and recommended');
    },
  },
  {
