...
/**
 * Cumulative score that banks one feast point. Scaled by the measured
 * `COMPANION_FEAST_MOMENTUM_SCORE_CALIBRATION` (250 × 2.6 → 650) so merge
 * chains and Feast Fever do not silently accelerate the reward bar.
 */
export const COMPANION_FEAST_SCORE_PER_FEAST_POINT = 650;
