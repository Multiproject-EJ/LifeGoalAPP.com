...
export type IslandRunCommitActionStatus = 'applied' | 'conflict' | 'error';

export interface IslandRunCommitActionResult {
  status: IslandRunCommitActionStatus;
  nextVersion?: number;
  error?: { message?: string | null; code?: string | null };
}

interface CommitRuntimeSnapshotOptions {
