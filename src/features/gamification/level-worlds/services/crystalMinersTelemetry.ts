...
import { minerCourseProfile, minerCourseHeight, getMinerReadiness, minerBuyTier, minerChestsRequired, type CrystalMinersProgress, type MinerCommand, type MinerSimulation } from './crystalMinersGame';

export const CRYSTAL_MINERS_BALANCE_VERSION = '2026-09-19.6';
