 ...
 * (latest: supabase/migrations/0259_combined_journey_reward_ladder_eggs.sql),
 ...
 * grant switch.
 *
 * Reward kinds live so far: dice, essence, egg. Reroll-capacity upgrades are
 * added in a later slice (the ledger CHECK already allows that kind).
 */
 ...
 * thresholds divisible by 3 grant an egg; otherwise even thresholds grant dice
 * and odd thresholds grant essence.
 */
