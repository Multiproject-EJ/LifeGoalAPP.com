...
export const featureAvailabilityRegistry = {
  ...
  'app.compass_book': {
    ...
    shortPitch: 'Build a durable personal compass through six guided chapters and real-life practice.',
  },
  'today.visionStar': {
    id: 'today.visionStar',
    label: 'Vision Star',
  ...
  'score.leaderboard': {
    ...
    description: 'Explicitly opt-in asynchronous ranking using Combined Journey XP.',
    status: 'live',
    publicAccess: 'open',
    adminAccess: 'open',
    surface: 'ScoreTab',
    category: 'scoreHub',
    shortPitch: 'A privacy-safe Adventure League where personal progress becomes friendly multiplayer.',
    votingEnabled: false,
    voteCategory: 'scoreHub',
  },
  'score.bank': {
